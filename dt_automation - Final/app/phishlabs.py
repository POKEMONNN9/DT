...
def test_phishlabs_connection():
    """
    Test connection to PhishLabs API
    ...
    try:
        ...
        if success:
            ...
            return True, {'message': 'PhishLabs connection successful', 'api_type': 'Case API'}
        else:
            logger.warning(f"PhishLabs connection test failed: {result}")
            return False, result
    except Exception as e:
